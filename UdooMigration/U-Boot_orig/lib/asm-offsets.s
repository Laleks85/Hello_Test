	...
	.file	"asm-offsets.c"
@ GNU C (GCC) version 4.8.2 (arm-poky-linux-gnueabi)
@	compiled by GNU C version 4.8.2, GMP version 5.1.1, MPFR version 3.1.2, MPC version 1.0.2
@ GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
@ options passed:  -nostdinc -I include
@ -I /home/tic-imx/Desktop/UdooMigration/U-Boot_orig/arch/arm/include
@ -D __KERNEL__ -D CONFIG_SYS_TEXT_BASE=0x17800000 -D CONFIG_ARM -D __ARM__
@ -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /opt/poky/1.6.1/sysroots/x86_64-pokysdk-linux/usr/lib/arm-poky-linux-gnueabi/gcc/arm-poky-linux-gnueabi/4.8.2/include
...
@ -mfloat-abi=soft -mtls-dialect=gnu -auxbase-strip lib/asm-offsets.s -g
...
.LFE143:
	...
	.text
.Letext0:
	.file 2 "/home/tic-imx/Desktop/UdooMigration/U-Boot_orig/arch/arm/include/asm/types.h"
...
.LASF58:
	.ascii	"/home/tic-imx/Desktop/UdooMigration/U-Boot_orig/\000"
.LASF17:
...
.LASF56:
	...
	.ascii	"ned-access -mfloat-abi=soft -mtls-dialect=gnu -g -O"
	.ascii	"s -fno-builtin -ffreestanding -fno-stack-protector "
	.ascii	"-fstack-usage -ffunction-sections -fdata-sections -"
